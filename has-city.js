...
The new function takes a string, called city, as a parameter and 
which determines whether the array contains that string or not.
...
*/
 function hasCity(country, cities) {
    return function(city) {
        return `${city} is ${cities.includes(city)?'':'not '}a city from ${country}`;
    }
}   